...
These correspond exactly to the six domains evaluated in the paper and match
the JSON metadata output stored in UTMF-CORE runs.
...
please cite UTMF-CORE (see main repository `README.md`).
